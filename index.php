  ...
  <main>
    ...
    <section class="py-5 mb-5">
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
            <h3 class="mb-3 fw-normal">We drive digital transformation with expertise in eCommerce, UI/UX, SAP, Adobe, and Java, delivering tailored solutions to empower businesses and achieve their goals.</h3>
            <div class="row">
